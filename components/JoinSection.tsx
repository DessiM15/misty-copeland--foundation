...
export default function JoinSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-ink py-24 text-center sm:py-32">
      <div className="container-content relative">
        ...
        {sent ? (
          ...
          >
            ...
            />
            <button type="submit" className="btn bg-white px-7 py-4 text-ink hover:bg-gold">
              Join Us
            </button>
          </form>
        )}
